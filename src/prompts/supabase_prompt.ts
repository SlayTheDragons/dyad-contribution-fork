...
- Dyad relies on the Supabase CLI (e.g., supabase functions serve <name> and supabase functions deploy <name>) which automatically bundles anything imported from../shared, so no extra build steps are required.
